<template>
        ...
        <section class="showcase_background background3">
            <div class="showcase_background_text">
                <h3>The Print Collection</h3>
<!--               
                <div>
                    <a>View more</a>
                </div> -->
        ...
        <div class="section_title" data-aos="zoom-in-right">
            <h3 class="text-uppercase">Let the cart be filled with art</h3>
        ...
        <div class="gallery_grid">
            ...
            <div class="grid_image short_length" data-aos="fade-up" v-for="product in products" :key="product._id">
                <div class="main_image" :style="'background-image: url(' + product.originalCopy.mainImage +')'">
